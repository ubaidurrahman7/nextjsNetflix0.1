...
export default function Unauthpage() {
  ...
  const [showCurrentAns, setShowCurrentAns] = useState();
  return (
    <motion.div
      initial={{ opacity: 0 }}
      ...
      <main>
        <div className="bg-black">
          ...
          <div className="border-b-8 border-gray-800 pb-8">
            <div
              className="flex flex-col h-[85vh] lg:h-[95vh] text-white
             px-8 sm:px-14 md:px-28 lg:px-48 xl:px-80 mt-3 sm:mt-14  "
            >
              <h1
                className="mb-5 text-xl sm:text-3xl md:text-4xl lg:text-5xl
               text-bold text-center px-14 md:px-0 "
              >
              ...
              {questions.map((item, index) => (
                <div className="flex flex-col gap-3">
                  ...
                  >
                    <h2>{item.ques}</h2>
                    <PlusIcon color="white" className="h-7 w-7" />
                  </div>
